...
> **R:Esto ocurre ya que la directiva #include, lo que hace es buscar ese archivo en el sistema y copiar y pegar absolutamente todo su contenido directamente en tu código. Esos 821 renglones son el resultado de traer todas las declaraciones internas**
...
> **R:Ocurre porque no encontro el texto porque el preprocesador no entiende de comentarios.**
...
> **R: no encuentra nada, printf("[DEBUG] %s\n", ("Iniciando main"));**
...
> **R:El numero de linea en el archivo**
...
> **R:pushl, movl,movl, addl**

Explicá en términos generales qué hacen esas instrucciones
(usá los comentarios del laboratorio como guía):

> **R:PUSH, Toma un valor y lo coloca en la punta de la pila. MOV: COPIA UN DATO DESDE EL ORIGEN HASTA EL DESTINO, ADD: SUMA UN VALOR**
...
> **R:.globl  _llamadas_llamadas: movl    _llamadas, %eax  movl    %eax, _llamadas movl    _llamadas, %eax**
...
> **R:Porque en programa.o no esta defina area_circulo**
...
> **R:___deregister_frame_info y ___register_frame_info.**
...
> **R:Aparecen símbolos como ___deregister_frame_info y ___register_frame_info. Estos no pertenecen a mi código, sino que son funciones de soporte del runtime de C y del sistema operativo. Se mantienen como U (indefinidas) en la tabla de símbolos porque se resolverán de forma dinámica cuando el programa se esté ejecutando en Windows.**
...
> **R:una macro es como un "buscar y reemplazar" automático, mientras que una función es una caja de herramientas real que el programa usa cuando lo necesita, cuadrado dessaparece en el preprocesamiento y sumar en el enlazado, tiene verificadocion de tipos**
...
> **R:Uno representa el código ejecutable de las funciones y el otro D, representa variables globales o estáticas que ya tienen un valor inicial**
